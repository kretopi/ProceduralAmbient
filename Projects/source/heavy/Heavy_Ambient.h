...
#ifndef _HEAVY_AMBIENT_H_
#define _HEAVY_AMBIENT_H_
 ...
 */
HeavyContextInterface *hv_Ambient_new(double sampleRate);
 ...
 */
HeavyContextInterface *hv_Ambient_new_with_options(double sampleRate, int poolKb, int inQueueKb, int outQueueKb);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // _HEAVY_AMBIENT_H_
